...
//		});
					...
					public void actionPerformed(ActionEvent e) {
						...
						pirktSpinner.addChangeListener(new ChangeListener() {
							public void stateChanged(ChangeEvent e) {
								double cena = Double.parseDouble(pirktGatavaPoga.getText().substring(0, pirktGatavaPoga.getText().length()-1).replace(',', '.'));
						...
						gatavacm30.addMouseListener(new MouseAdapter() {
							   public void mouseEntered(MouseEvent e) { gatavacm30.setText("2.60€"); }
								public void mouseExited(MouseEvent e) { gatavacm30.setText("30 cm"); }
							}
						);
						gatavacm60.addMouseListener(new MouseAdapter() {
							   public void mouseEntered(MouseEvent e) { gatavacm60.setText("10.18€"); }
								public void mouseExited(MouseEvent e) { gatavacm60.setText("60 cm"); }
							}
						);
		salamiPoga.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				buvetAprakstu("20 cm");buvetAprakstu("Plāna mīkla"); buvetAprakstu("Parastais siers"); buvetAprakstu("Tomātu mērce");
		...
		bbqPoga.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				buvetAprakstu("20 cm");buvetAprakstu("Plāna mīkla"); buvetAprakstu("Parastais siers"); buvetAprakstu("BBQ mērce");
		...
		sieraPoga.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				buvetAprakstu("20 cm");buvetAprakstu("Plāna mīkla"); buvetAprakstu("Tomātu mērce"); 
		...
		laukuPoga.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				buvetAprakstu("20 cm");buvetAprakstu("Plāna mīkla"); buvetAprakstu("Tomātu mērce"); buvetAprakstu("Mocarella siers"); buvetAprakstu("Ķiršu tomāti");
		...
		ciliPoga.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				buvetAprakstu("20 cm");buvetAprakstu("Plāna mīkla"); buvetAprakstu("Tomātu mērce"); buvetAprakstu("Parastais siers"); buvetAprakstu("Tomāti"); buvetAprakstu("Sīpoli");
				gatavaApraksts = buvetAprakstu("Jalapeno pipari");
		...
		spinner.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				double cena = Double.parseDouble(pirktPoga.getText().substring(0, pirktPoga.getText().length()-1).replace(',', '.'));
		...
		cm20.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { cm20.setText("8.99€"); }
				public void mouseExited(MouseEvent e) { cm20.setText("20 cm"); }
			}
		);
		cm30.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { cm30.setText("12.59€"); }
				public void mouseExited(MouseEvent e) { cm30.setText("30 cm"); }
			}
		);
		cm60.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { cm60.setText("17.99€"); }
				public void mouseExited(MouseEvent e) { cm60.setText("60 cm"); }
			}
		);

		tomatuPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { tomatuPoga.setText("1.89€"); }
				public void mouseExited(MouseEvent e) { tomatuPoga.setText("Tomātu"); }
			}
		);
		bbqsPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { bbqsPoga.setText("3.29€"); }
				public void mouseExited(MouseEvent e) { bbqsPoga.setText("BBQ"); }
			}
		);
		parastsPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { parastsPoga.setText("4.99€"); }
				public void mouseExited(MouseEvent e) { parastsPoga.setText("Parasts"); }
			}
		);
		zilaisPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { zilaisPoga.setText("2.49€"); }
				public void mouseExited(MouseEvent e) { zilaisPoga.setText("Zilais"); }
			}
		);
		mocarellaPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { mocarellaPoga.setText("2.49€"); }
				public void mouseExited(MouseEvent e) { mocarellaPoga.setText("Mocarella"); }
			}
		);
		salamisPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { salamisPoga.setText("3.99€"); }
				public void mouseExited(MouseEvent e) { salamisPoga.setText("Salami"); }
			}
		);
		skinkisPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { skinkisPoga.setText("4.19€"); }
				public void mouseExited(MouseEvent e) { skinkisPoga.setText("Šķiņkis"); }
			}
		);
		vistaPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { vistaPoga.setText("2.49€"); }
				public void mouseExited(MouseEvent e) { vistaPoga.setText("Vista"); }
			}
		);
		senesPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { senesPoga.setText("2.29€"); }
				public void mouseExited(MouseEvent e) { senesPoga.setText("Sēnes"); }
			}
		);
		ananasiPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { ananasiPoga.setText("2.29€"); }
				public void mouseExited(MouseEvent e) { ananasiPoga.setText("Ananāsi"); }
			}
		);

		tomatiPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { tomatiPoga.setText("2.19€"); }
				public void mouseExited(MouseEvent e) { tomatiPoga.setText("Tomāti"); }
			}
		);
		jalapenoPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { jalapenoPoga.setText("2.19€"); }
				public void mouseExited(MouseEvent e) { jalapenoPoga.setText("Jalapeno"); }
			}
		);
		sipoliPoga.addMouseListener(new MouseAdapter() {
			   public void mouseEntered(MouseEvent e) { sipoliPoga.setText("0.49€"); }
