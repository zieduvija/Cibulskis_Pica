...
public class Main extends JFrame{
	...
	public Main() {
		...
		buvetEkrans.setBackground(new Color(189, 195, 199));
		contentPane.setLayer(buvetEkrans, 8);
		buvetEkrans.setBounds(0, 0, 1000, 850);
		contentPane.add(buvetEkrans);
		buvetEkrans.setLayout(null);
		
		
		JLabel tavaPicaLogo = new JLabel();
		tavaPicaLogo.setIcon(new ImageIcon(Main.class.getResource("/bildes/buvet.png")));
		tavaPicaLogo.setBounds(340,37, 300, 90);
		buvetEkrans.add(tavaPicaLogo);
		
		
		//Izmers
		
		JToggleButton cm20 = new JToggleButton("20cm");
		cm20.setBounds(387,196,115,34);
		cm20.setFont(new Font("Inter", Font.PLAIN, 14));
		...
		cm30.setBounds(522,196,115,34);
		cm30.setFont(new Font("Inter", Font.PLAIN, 14));
		...
		cm60.setBounds(657,196,115,34);
		cm60.setFont(new Font("Inter", Font.PLAIN, 14));
		...
		JToggleButton bieza = new JToggleButton("Bieza");
		bieza.setBounds(387,291,115,34);
		bieza.setFont(new Font("Inter", Font.PLAIN, 14));
		bieza.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		buvetEkrans.add(bieza);
		
		JToggleButton videja = new JToggleButton("Vidēja");
		videja.setBounds(522,291,115,34);
		videja.setFont(new Font("Inter", Font.PLAIN, 14));
		videja.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		buvetEkrans.add(videja);
		
		JToggleButton plana = new JToggleButton("Plāna");
		plana.setBounds(657,291,115,34);
		plana.setFont(new Font("Inter", Font.PLAIN, 14));
		plana.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		buvetEkrans.add(plana);
		
		
		//Merces
		
		
		JToggleButton tomatu = new JToggleButton("Tomātu");
		tomatu.setBounds(387,379,115,34);
		tomatu.setFont(new Font("Inter", Font.PLAIN, 14));
		tomatu.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		buvetEkrans.add(tomatu);
		
		JToggleButton bbq = new JToggleButton("BBQ");
		bbq.setBounds(522,379,115,34);
		bbq.setFont(new Font("Inter", Font.PLAIN, 14));
		bbq.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		buvetEkrans.add(bbq);
		
		JToggleButton bez = new JToggleButton("Bez");
		bez.setBounds(657,379,115,34);
		bez.setFont(new Font("Inter", Font.PLAIN, 14));
		bez.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		buvetEkrans.add(bez);
